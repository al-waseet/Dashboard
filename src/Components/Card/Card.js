...
import Icon_Selector from '../Icon_Selector/Icon_Selector';
...
const Card = ({Add_an_Item, Addons, Category, Currency, Delete_the_Item, Description, ID, Name, New_Item_Status, Photo, Price, Save_the_Item}) =>
{
	...
	return <div className='Card'>
		...
		<Icon_Selector Classes={['Card_Image_Container']} Current_Image={Card_Photo} Function={(Event) => Change_the_Photo (Event.target.files [0])} ID={ID}></Icon_Selector>
