...
const Banner = ({Category, Change_the_Banner_Image, Change_the_Banner_Name, Delete_the_Category, Toggle, Toggle_Status}) =>
{
	...
	return <div className='Banner' style={{backgroundImage: `url(${Banner_Image})`}}>
		...
		<Image_Button Function={(Event) => Change_the_Banner_Image_Value (Event.target.files [0])}></Image_Button>
	</div>
}
